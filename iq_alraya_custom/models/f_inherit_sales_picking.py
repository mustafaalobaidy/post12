...
class iq_inherit_lot_po_lines(models.Model):
    _inherit = 'purchase.order.line'

    
    
    iq_lot_no = fields.Many2one('stock.production.lot',string='Lot Number', copy=False)
    ...
    def _onchange_product_id_set_lot_domain(self):
        available_lot_ids = []
        if self.order_id.picking_type_id.warehouse_id and self.product_id:
            location = self.order_id.picking_type_id.warehouse_id.lot_stock_id
